...
test.describe('Publishing Episode', () => {
    test('Publish Episode', async ({page}) => {
        ...
        await page.getByRole('row', { name: '241_thefeed.mp3 audio/mpeg 29.29 MB Select', exact: true }).click();
        ...
        */
        ...
        await page.locator('body').setInputFiles('Episode Artwork Image.png');
